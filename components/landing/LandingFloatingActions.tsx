          ...
          >
            ...
            <div className="flex items-start gap-3 pl-10">
              ...
              <div className="min-w-0">
                ...
                >
                  ذخیره مخاطب از دکمه شناور مدیریت می‌شود
                </h2>
                <p className="mt-2 text-sm leading-7 text-slate-600">
                  این بلاک همیشه داخل دکمه شناور باقی می‌ماند. اگر گزینه
                  نمایش به صورت بلاک در صفحه را روشن کنید، همین دکمه داخل
                  بدنه صفحه هم نمایش داده می‌شود و مثل باقی بلاک‌ها قابل
                  ویرایش است.
                </p>
              </div>
            </div>

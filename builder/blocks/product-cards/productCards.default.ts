...
export function createDefaultProductCardsBlock(order: number): PageBlock {
    ...
    return {
        ...
        data: {
            ...
            showBottomPrimaryButton: true,
            bottomPrimaryButtonText: "مشاهده همه محصولات",
            bottomPrimaryButtonUrl: "",
            showBottomSecondaryButton: true,
            bottomSecondaryButtonText: "مشاوره خرید",
            bottomSecondaryButtonUrl: "",
            bottomButtonsOpenInNewTab: true,
            products: [
                {
                    id: "product-1",
                    name: "محصول اول",
